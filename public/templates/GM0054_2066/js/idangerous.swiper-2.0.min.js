var Swiper = function(a, b) {
	...
	function O(a, c, d) {
		function k() {
			...
			1000 / 60)) : (b.onSlideChangeEnd && b.onSlideChangeEnd(e), o ? e.setWrapperTranslate(a, 0) : e.setWrapperTranslate(0, a), e._DOMAnimating = !1)
		}
	...
	if (window.getComputedStyle || (window.getComputedStyle = function(a) {
		...
		e.fixLoop = function() {
			if (e.activeIndex < e.loopedSlides) {
				...
				if (e.activeIndex > e.slides.length - 2 * b.slidesPerView) {
		...
		e.loadSlides = function() {
			...
			d = b.loader.loadAllSlides ? c.length: b.slidesPerView * (1 + b.loader.surroundGroups), f = 0; d > f; f++) {
