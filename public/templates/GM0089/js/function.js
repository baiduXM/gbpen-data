...
/*美工专属区域*/
$(".menulist .swiper-nav span").height($(".menulist .swiper-nav span").width()+2+"px")
var m1=$(".menulist .swiper-nav span .pic img").height()
$(".menulist .swiper-nav span .pic").height($(".menulist .swiper-nav span .pic").width())

var n=($(".menulist .swiper-nav span .pic").height()-$(".menulist .swiper-nav span .pic .iconfont").height())*0.45
...
$(".menulist .swiper-nav span").each(function(n){
			
			if(n%3==1){
			$(this).addClass("aa");
			$(this).find(".pic").addClass("bb");
			   }
			
		  if(n%3==2){
			$(this).addClass("cc");
			$(this).find(".pic").addClass("dd");
			
			
			   }
	})

$("section div.wrapper").each(function(n){
...
$(".bg1").wrapInner('<div class="bg1_top"></div>')
$(".bg1").wrapInner('<div class="bg1_bottom"></div>')
$(".bg2").wrapInner('<div class="bg2_top"></div>')
$(".bg2").wrapInner('<div class="bg2_bottom"></div>')



var b=($("#in_text .inner").width()-$("#in_text .inner .line").width())*0.5
$("#in_text .inner .line").css({"left":b})
var c=($("#in_text .inner").width()-$(".aa").width())*0.5
$(".aa").css({"left":c})
$("#in_page .inner .pic").height($("#in_page .inner .xx .pic_bg").height())
