$(document).ready(function() {
	...
	$(".nav .sub li:first-child").css({"paddingTop":"7px"});
	$(".nav .sub li:last-child").css({"paddingBottom":"25px"});
 
	//首页新闻
	$(".indexnews ul li:nth-child(4)").css({"marginTop":"-55px","marginBottom":"106px","marginLeft":"166px","z-index":"8"});
	$(".indexnews ul li:nth-child(5)").css({"marginTop":"-55px","marginBottom":"106px","z-index":"8"});
