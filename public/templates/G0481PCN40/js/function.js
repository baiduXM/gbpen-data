...
<!--美工编写区域-->
	jQuery("#product .inner").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:5,interTime:50});
...
adap_box("#news",140,140,460);


/*首页产品列表图片自适应*/
    adap_pro("#product .inner ul li .pic",194,194);
...
$("#news .inner ul li:first-child").css({"border-bottom":"1px solid #f0f0f0","margin-top":"18px"});
