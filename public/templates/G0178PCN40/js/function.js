...
$(".xz").each(function(){   
	...
	// 			// var ind = 2; //初始位置
	// 			// var nav= jQuery(".nav");
	// 			// var inits = jQuery(".nav .m").eq(ind);
	// 		// var block = jQuery(".nav .block"); //滑块
	// 		// block.css({"left":inits.position().left-3}); //初始化滑块位置
	// 		// nav.hover(function(){},function(){ block.animate({"left":inits.position().left-3},100); }); //移出导航滑块返回
