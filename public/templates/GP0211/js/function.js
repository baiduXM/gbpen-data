...
<!--美工-->
 ...
 <!--设计团队-->
$(".product .inner ").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});

$(".picScroll-top").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"top",autoPlay:true,vis:2,trigger:"click"});

	
<!--友情链接-->	

$(".link").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:6,interTime:50});	
...
window.onload=function(){
 ...
 $(".news ul li").each(
 function(){
	 var w1=$(this).find(".news_img").width()
	 $(this).find(".news_text").width(775-w1-85)
	 }
 )	
...
<!--关于我们-->
 $(".about").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-85)
	 }
 )	
...
adaption(".product .inner ul li .pic",165,165)

adaption(".case .inner ul li .pic",165,165)
