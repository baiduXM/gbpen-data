...
<!--美工编写区域-->
    ...
    jQuery("#news .inner").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});
...
// adap_box(".news",180,75,290);
adap_box(".about",340,332,790);


/*首页产品列表图片自适应*/
adap_pro("#product .inner ul li .pic",264,264);
    adap_pro("#news .inner ul li .pic",266,220);
<!--美工编写区域-->
...
function starColor(html,data){
    ...
    data.empty().append("<span style='color: #ad0101; font-size: 24px;'>"+reg+"</span>"+reg1);
}
$(document).ready(function() {
    ...
    // starColor($(".sub_red").html(),$(".sub_red"));
    // console.log($(".sub_red").html());
    // console.log($(".pro"));
