...
$("#banner .slideBox").slide({mainCell:".bd ul",autoPlay:true, effect:"fold", trigger:"click",interTime:2000});		
<!--产品中心-->	

$(".products li").each(function(i){
	$(".products li").slice(i*2,i*2+2).wrapAll("<ul></ul>")
	})
	jQuery(".products").slide({titCell:".hd ul",mainCell:".bd .ulWrap",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50 ,trigger:"click"});
  
$(".news_bg .shuzi").each(function (i) {
        $(this).text("0"+(i+1));
      });
  ...
  $(".products ul li").hover(
	...
	function(){
		 $(this).find(".more").animate({bottom:105,opacity:"1"})
		 },
	
	function(){

		$(this).find(".more").animate({bottom:-105,opacity:"0"})		  
  })  
...
<!--新闻-->			
$(".news_bg .inner .news_kuan").each(
 function(){
	 $(this).find(".newstext").width($(this).width()-$(this).find(".newsimg img").width()-60)
	 }
 )
...
$(".link").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:7,interTime:50});	

<!--案例展示-->	

$(".case").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:2,interTime:50});	
...
/*首页产品列表图片自适应*/
adaption(".products ul li .pic",250,250)

adaption(".case ul li .pic",200,200)
