...
$(document).ready(function(){
	...
	$("ul.onee li").hover(function(){
                $(this).find("ul.twoo").stop(false,true).slideDown("fast")
                },function(){
                $(this).find("ul.twoo").stop(false,true).slideUp("fast")
                })
	...
	$("#menu2 li a").hover(function(){
		$(".out",this).stop().animate({'top':'49px'},200);
		$(".over",this).stop().animate({'top':	'0px'},200);
	},function(){
		$(".out",this).stop().animate({'top':'0px'},200);
		$(".over",this).stop().animate({'top':'-49px'},200);
	});
