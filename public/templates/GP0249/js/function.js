...
$("#case .case_inner .slideBox").slide({mainCell:".bd ul",autoPlay:true,nterTime:3000});

var w=Math.floor($(window).width()/563)
		
		$(".picScroll-left").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"leftLoop",autoPlay:true,vis:w,trigger:"click"});



$("#news ul li:last").css({"margin-right":"0px"});
})
...
adaption("#pro .inner ul li .pic",283,283)
