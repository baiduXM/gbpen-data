...
var n=($(".ch").width()+$(".en").width())
var m=($(".h2_margin").width()-n)*0.4
$(".center").css({"margin-left":m})



 $("#in_text ul li .number").each(function (i) {
			if(i<9){
        $(this).text("0"+(i+1))}
		else{
			$(this).text(i+1)
 ...
 $(".list_imagetext ul li .number").each(function (i) {
