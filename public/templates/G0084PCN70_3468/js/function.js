...
// 导航
	...
	if (index == null ||index == 0 ||index=="index.html") {
		$("ul.nav>li:eq(0)>a").addClass('in');
		console.log(index)
	} else {
		$("ul.nav>li:eq(0)>a").removeClass('in');
	}
	...
	jQuery("#banner").slide({ titCell:".dot ol", mainCell:"ul.picture", effect:"left",  autoPlay:false,mouseOverStop:false, autoPage:true, trigger:"click",interTime:40000000000000 });
