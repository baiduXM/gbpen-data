...
$("section div.wrapper").css({"margin-bottom":"10px","margin-top":10})

$(".menulist .swiper-nav span .icon").height($(".menulist .swiper-nav span .icon").width())
$(".swiper-nav,.navlist,.menulist,.swiper-wrapper,.swiper-slide").height($(".menulist .swiper-nav span").innerHeight())



var t=($(".menulist .swiper-nav span .icon").width()-$(".menulist .swiper-nav span .icon i.iconfont").width())*0.5
var y=($(".menulist .swiper-nav span .icon").height()-$(".menulist .swiper-nav span .icon i.iconfont").height())*0.5

$(".menulist .swiper-nav span .icon i.iconfont").css({"font-size":35,"display":"block","margin-top":t,"color":"#fff"})
