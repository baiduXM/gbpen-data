...
/*美工专属区域*/
$("section div.wrapper:last").css({"margin-bottom":15})
...
$(".boxmain-top").height($(".boxmain-top .pix img").height())

$("#homenav ul li").height($("#homenav ul li .pix").height())

var m=($("#homenav ul li").height()-$("#homenav ul li .right").height())*0.5
$("#homenav ul li .right").css({"margin-top":m})
$(".boxmain-top .text").height($(".boxmain-top .text").width())
$(".boxmain-top .text .bg").height($(".boxmain-top .text .bg").width())

var n=($(".boxmain-top .text .bg").height()-$(".boxmain-top .text .bg .fanwei").height())*0.45
$(".boxmain-top .text .bg .fanwei").css({"margin-top":n})


$("#homenav ul li .right .nav_name i.iconfont").css({"color":"#0b3077","font-size":50})
