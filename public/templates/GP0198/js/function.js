...
$("#case .slideBox").slide({mainCell:".bd ul",autoPlay:true,nterTime:3000});
...
$("#pro .inner").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:5,interTime:50});
...
adaption("#pro .inner ul li .pic",180,180)
