...
$(".nav_img").height($(".nav_img").width())
$(".swiper-wrapper").height($(".nav_img").width()+$(".zh").height())
$(".swiper-slide").height($(".swiper-slide").width())	
$(".swiper-nav,.swiper-slide").height($(".nav_img").width()+$(".zh").height())	


$(".nav_img .iconfont").css({"font-size":26})
var x=$(".nav_img").height()+"px"
$(".nav_img .iconfont").css({"line-height":x,"height":x})
...
<!--$(".menulist .swiper-slide:first-child").addClass(cc)-->



$(".menulist .swiper-slide").eq(0).addClass("cc")

/*var n=$(".in_h2").height()*0.7
$(".bg2").css({"height":n})*/

$(".bg2 ").height($(".in_h2").height()*1.2) 
$("div section .xx").css({"margin-top":20,"margin-bottom":20, })
