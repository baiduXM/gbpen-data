$(document).ready(function(){
	...
	$(".indexmenu").height($(window).height()*1/4);
	$(".indexmenu ul li").height($(".indexmenu").height()/7+"px")	
	$(".indexmenu ul li a").css({"line-height":$(".indexmenu ul li").height()+"px"})
/*	$(".indexmenu").css({"top":$(".logo").height()+"px"})
*/	$(".next2 dl .nextright").width($(".next2 dl").width()-$(".next2 dl .nextleft").width()-2)
	...
	$(".baner").height($(window).height()-$(".foot").innerHeight())
