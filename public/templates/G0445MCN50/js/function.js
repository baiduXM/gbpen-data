$(document).ready(function(){
  ...
  doc.addEventListener('DOMContentLoaded',recalc,false);
    ...
    // 首字
    if($(".navbox ul li:nth-child(1) .nav,.box_titles h2 .poanav").size()>0){
      var str=$(".navbox ul li:nth-child(1) .nav,.box_titles h2 .poanav").html();
      var target="<i>"+str.substring(0,1)+"</i>";
      $(".navbox ul li:nth-child(1) .nav,.box_titles h2 .poanav").html(target+str.substr(1));
    }
