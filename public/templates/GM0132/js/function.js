...
$(".logo_bg").height($(".logo").height())


$(".menulist .swiper-nav span").height($(".menulist .swiper-nav span").width()-20)

$(".swiper-slide,.menulist .swiper-nav .swiper-wrapper").height($(".menulist .swiper-nav span").height())



var t=($(".menulist .swiper-nav span").height()-$(".menulist .swiper-nav span .icon").height()-$(".menulist .swiper-nav span .zh").height()-7)*0.5
$(".menulist .swiper-nav span .icon").css({"margin-top":t})
