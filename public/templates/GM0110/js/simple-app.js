$(function(){
	...
	var indexnav = $('.swiper-nav').swiper({
		slidesPerView:4,
		freeMode:true,
		freeModeFluid:true,
  ...
  $('.arrow-right').on('click', function(e){
	...
	if($('.nymenu .swiper-slide').last().hasClass('swiper-slide-visible')){
		$('.arrow-right').addClass("current1");

	}
	function slide_state(){
		if($('.nymenu .swiper-slide').first().hasClass('swiper-slide-visible')){
