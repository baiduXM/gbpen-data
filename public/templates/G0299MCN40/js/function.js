...
var n=$(".menulist .swiper-nav span .pic").height()+"px"
$(".menulist .swiper-nav span .pic").css({"line-height":n})
var m=($(".menulist .swiper-nav span .pic").width()-$(".menulist .swiper-nav span .pic img").width())*0.5
$(".menulist .swiper-nav span .pic img").css({"left":m})
$(".menulist,.swiper-slide,.swiper-wrapper,.navlist").height($(".menulist .swiper-nav span").height())
$("#in_text ul li:odd .pic").css({"float":"right","marginRight":"0"})

 $("section div .math").each(function (i) {
        $(this).text(i+1);
      });
