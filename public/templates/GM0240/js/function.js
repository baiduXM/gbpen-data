...
$(".swiper-slide,.menulist, .swiper-nav .swiper-wrapper").height($(".menulist .swiper-nav span").height()+10)

var g=($(".menulist .swiper-nav span ").height()-$(".menulist .swiper-nav span .icon ").height()-$(".menulist .swiper-nav span .zh ").height())*0.5
$(".menulist .swiper-nav span .icon ").css({"margin-top":g})

$(".menulist .swiper-nav span .icon .iconfont").css({"font-size":35,"color":"#fff"})
