...
var visible=1
$('#prizes .photo1.enable').jCarouselLite({
	btnPrev: '#prizes a.photos-prev',
	btnNext: '#prizes a.photos-next',
	visible: visible,
	auto: (Math.floor($('#prizes .photo1 li').length)<visible ? 0:3000),
	speed: 1000,
	vertical: true	
}).css({visibility:"visible"});	
$('#prizes .photo2.enable').jCarouselLite({
	btnPrev: '#prizes a.photos-prev',
	btnNext: '#prizes a.photos-next',
	visible: visible,
	auto: (Math.floor($('#prizes .photo2 li').length)<visible ? 0:3000),
	speed: 1000,
	vertical: true	
}).css({visibility:"visible"});	
});