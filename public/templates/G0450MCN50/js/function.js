$(document).ready(function() {	
        ...
        //banner
        $('.swiper-container-banner').swiper({slidesPerView: 1,nextButton: '.swiper-button-next-banner',prevButton: '.swiper-button-prev-banner',paginationClickable: true,spaceBetween: 30,autoplay:2500,autoplayDisableOnInteraction:false});
        
        //case
        $('.swiper-container-case').swiper({slidesPerView: 1,nextButton: '.swiper-button-next-case',prevButton: '.swiper-button-prev-case',pagination: '.swiper-pagination-case li',paginationClickable: true,spaceBetween: 30,autoplay:2500,autoplayDisableOnInteraction:false});
