$(document).ready(function() {
	...
	$(window).load(function() {
		...
		$(".menu_list").height($(".menu_list").width())
		if ($(".menu").height() < $(".index-wrap").height() - $(".header").height() - $(".index_edite").height() - $(".foot").height()) {
			$(".index_foot").addClass("position")
		}
	});
	$(window).resize(function() {
		...
		if ($(".menu").height() < $(".index-wrap").height() - $(".header").height() - $(".index_edite").height() - $(".foot").height()) {
			...
			$(".index_foot").removeClass("position")
		}
	})
