...
$(".swiper-slide,swiper-wrapper,.menulist .navlist").height($(".menulist .swiper-nav span").height())

$("section div.wrapper:last").css({"margin-bottom":20})


var m=-($(".menulist .navlist").height()*0.5)+"px"
$(".menulist .navlist").css({"margin-top":m})
