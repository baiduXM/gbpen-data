...
/*美工专属区域*/
$("section div.wrapper").css({"margin-bottom":15,"margin-top":15})
...
var t=($(".menulist .swiper-nav span .icon").height()-$(".menulist .swiper-nav span .icon i.iconfont").height())*0.5
$(".menulist .swiper-nav span .icon i.iconfont").css({"margin-top":t,"font-size":25})
