...
$(".news ul li:last").css("background","none");
});
...
adaption(".products .inner ul li .pic",245,245)


<!--产品中心-->

    $(".products .inner ul li").each(function(){
    var w = $(this).find("img").width() 
	
	$(this).find(".line").width(w-10) 
	 var x = $(this).find("img").height() 
	$(this).find(".line").height(x-10) 
    });
	
<!--新闻中心-->
	
    $(".news ul li").each(function(){
    var q = $(this).find("img").width() 	
	$(this).find(".line").width(q-10) 
	
	 var e = $(this).find("img").height() 
	$(this).find(".line").height(e-10) 
    });
