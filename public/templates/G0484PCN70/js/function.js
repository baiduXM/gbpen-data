 $(document).ready(function(){
	...
	if (!(/msie [6|7|8|9]/i.test(navigator.userAgent))){
 	...
 	jQuery(".douban").slide({ mainCell:".bd ul", effect:"left", delayTime:800,vis:1,scroll:1,pnLoop:false,trigger:"click",easing:"easeOutCubic" });
	...
	(function(){
		$('.propage li a').each(function(index){
			$(this).hover(function(){
				...
				$(this).find('.hoverpic em').addClass('wow animated flipInY')
			},function(){
				$(this).find('.hoverpic').stop(true,true).animate({'top':292},500)
				$(this).find('.hoverpic em').removeClass('wow animated flipInY')
			})
		})
	})();
