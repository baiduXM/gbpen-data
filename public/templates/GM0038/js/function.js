$(document).ready(function(){
	...
	$(".yuaters").height($(".yuan").height()-2)
	$(".yuaters").width($(".yuan").width()-2)
	$(".y_edns").width($(".yuan").height()-2)
	$(".y_edns").height($(".yuan").height()-2)
	$(".img_logo").width($(".y_edns").width()-14)
	$(".img_logo").height($(".y_edns").height()-14)	
	$(".cirley_top").height($(".y_edns").height()/2)
	$(".cirley_top").width($(".y_edns").width())		
	$(".mlist").height($(".mimg").height())
	$(".mlist_null").height($(".mimg").height())
    if($(window).width()>320&&$(window).width()<500){
	   $(".topmenu").height($(".index-wrap").height()-$(".foot").height()-96)		
	}else{
		$(".topmenu").height($(".index-wrap").height()-$(".foot").height()-96)
		}	 		
	});
