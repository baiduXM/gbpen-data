$(document).ready(function() {
	...
	$(window).load(function() {
		var img = new Image();
		img.src = $("ul.newslist li .img img").attr("src");

		$(".class-m").height($(".class").outerHeight() - $(".class-top").outerHeight())
		$(".index-wrap").height($(".wrap").height())
		$("ul.newslist li .nr_edi").height($("ul.newslist li .img img").height() - 2)
		$("ul.newslist li .nr_edi .nr").height($("ul.newslist li .nr_edi").height() - $("ul.newslist li .nr_edi .title").height() - 17)
		if ($(window).width() < 480) {
			$("ul.newslist li .nr_edi .nr").css("line-height", $("ul.newslist li .nr_edi .nr").height() / 3 + "px")
		} else {
			$("ul.newslist li .nr_edi .nr").css("line-height", $("ul.newslist li .nr_edi .nr").height() / 5 + "px")
		}
	});
