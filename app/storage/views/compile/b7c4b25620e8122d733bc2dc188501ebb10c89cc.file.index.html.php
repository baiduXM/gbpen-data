<?php /* Smarty version Smarty-3.1.19, created on 2015-11-12 06:28:40
         compiled from "D:\unify\app\views\templates\GM0071\index.html" */ ?>
<?php /*%%SmartyHeaderCode:67885643ec1e191b83-13128987%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b7c4b25620e8122d733bc2dc188501ebb10c89cc' => 
    array (
      0 => 'D:\\unify\\app\\views\\templates\\GM0071\\index.html',
      1 => 1447309712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '67885643ec1e191b83-13128987',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5643ec1e62ccb6_00474249',
  'variables' => 
  array (
    'site_another_url' => 0,
    'keywords' => 0,
...
<?php if ($_valid && !is_callable('content_5643ec1e62ccb6_00474249')) {function content_5643ec1e62ccb6_00474249($_smarty_tpl) {?><!DOCTYPE html>
...
?>
      ...
      <div id="in_page" class="wrapper clearfix">
      <h2 class="in_h2"><div class="in_h2ico"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['icon'];?>
</div><div class="in_zh"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['name'];?>
</div></h2>
        <div class="inner clearfix">
        <div class="page_img"><img src="<?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['image'];?>
"></div>
      ...
      <?php } elseif ($_smarty_tpl->tpl_vars['mIndexCat']->value['type']==1) {?> 
       <div id="in_text" class="wrapper clearfix">
        <h2 class="in_h2"><a href="<?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['link'];?>
"><div class="in_h2ico"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['icon'];?>
</div><div class="in_zh"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['name'];?>
</div></a></h2>
...
?>
              <li><a href="#">
                 <div class="in_no"><?php echo $_smarty_tpl->tpl_vars['article']->index+1;?>
</div>
              ...
              <?php if ($_smarty_tpl->tpl_vars['article']->index+1==2) {?><?php break 1?><?php }?> <?php } ?>
            </ul>
        </div>
        </div>
      ...
      <div id="in_image" class="wrapper clearfix">
       <h2 class="in_h2"><a href="<?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['link'];?>
"><div class="in_h2ico"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['icon'];?>
</div><div class="in_zh"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['name'];?>
</div></a></h2>
...
" width="100%" title="160*150"></div>
      ...
      <?php if ($_smarty_tpl->tpl_vars['mIndexCat']->value['showtype']==2) {?>
         <div id="in_image1" class="wrapper clearfix">
        <div class="in_cir"></div>
        <h2 class="in1_h2"><a href="<?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['link'];?>
"><div class="in1_zh"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['name'];?>
</div><div class="in1_en"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['en_name'];?>
</div></a></h2>
        <DIV class="in_txt"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['description'];?>
</div>
        <div class="inner1 yc">
<div class="baner">
