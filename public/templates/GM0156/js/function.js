...
/*美工专属区域*/
var m=($(".coffee").width()-$(".lamp").width())*0.5
$(".lamp").css({"left":m})
$(".lamp").height($(".lamp img").height())

$("#in_text .bot1").height($("#in_text .inner").height())
$("#in_text .bot2").height($("#in_text .inner").height())

$(".hide-class .bot1").height($(".hide-class").height())
$(".hide-class .bot2").height($(".hide-class").height())
