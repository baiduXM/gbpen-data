...
var m=($(".homenav ul li a .img").height()-$(".homenav ul li a .img .iconfont").height())*0.4+"px"
$(".homenav ul li a .img .iconfont").css({"font-size":"35px","top":m})


            if (screen.width <=640){
				
				var n=($(".homenav ul li a .img").height()-$(".homenav ul li a .img .iconfont").height())*0.3+"px"
              $(".homenav ul li a .img .iconfont").css({"font-size":"25px","top":n})
          }
