...
$(".picScroll-left").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"leftMarquee",autoPlay:true,vis:3,interTime:50,trigger:"click"});	

$(".news .inner ul li:odd").addClass("list1");
$(".news .inner ul li:even").addClass("list2");
...
adaption(".products .inner ul li .pic",95,95)
