...
$("#in_text ul li .data,.list_text ul li .data").height($("#in_text ul li .data,.list_text ul li .data").width())
var t=$("#in_text ul li .data, .list_text ul li .data").width()+"px"
$("#in_text ul li .data,.list_text ul li .data").css({"line-height":t})




var n=$("#in_text ul li,.list_text ul li").height()*0.15
$("#in_text ul li .data,.list_text ul li .data").css({"margin-top":n})
...
var n=$("#in_image").width()
var y=$("#in_image").height()



$(".triangle-topleft ").css({"border-right-width":n})
$(".triangle-topleft ").css({"border-top-width":y})
