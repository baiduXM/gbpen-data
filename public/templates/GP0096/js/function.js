...
jQuery("#banner .slideBox").slide({mainCell:".bd ul",autoPlay:true, effect:"fold", trigger:"click",interTime:4000});
...
$("#case ").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:6,interTime:50});
...
/*首页产品列表图片自适应*/
adaption("#products .inner ul li .pic ",105,105)
adaption("#case .inner ul li .pic ",140,140)
