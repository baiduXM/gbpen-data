...
$(".case .inner .slideBox").slide({mainCell:".bd ul",effect:"leftLoop",autoPlay:true});


$(".case .inner").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});
...
$(".case ul li").hover(
	...
	function(){
		  ...
		  $(this).find(".word").animate({top:214,opacity:"0.9" })
		 },
	
	function(){
	
			  
		$(this).find(".word").animate({top:0,opacity:"0"})		  
  }
  )



$(".news .news_text ul li a b").each(function (i) {
        $(this).text("0"+(i+1));
      });
...
$(".about").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-70)
	 }
 )	
...
$(".news").each(
 function(){
	 $(this).find(".news_text").width($(this).width()-$(this).find(".news_img img").width()-60)
	 }
 )		
...
adaption(".case .inner ul li .pic",250,250)

$(".case  ul li").each(function() {
    var w = $(this).find("img").width()
	
	$(this).find(".word").css({"width":w,"margin-left":-w*0.5})
});
