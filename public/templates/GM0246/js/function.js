...
var m=($("header").height()-$(".header_menu img").height())*0.5
...
var n=($(".sub_h1_bg1").height()-$(".sub_hight1").height())*0.5
$(".sub_hight1").css({"top":n})

var z=($(".sub_h1_bg1").height()-$(".sub_hight1").height())*0.5
$(".sub_hight2").css({"top":z})
