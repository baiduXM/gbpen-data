...
$(".case").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:3,interTime:50});	
...
adaption(".case .inner ul li .pic",125,125)
...
/*图文内页图片自适应*/	 
 ...
 function(){
	 ...
	 var wid2=$(this).width();
	 $(this).find(".text_box").width(wid2-wid1-18)
	 }
 )
