...
$(".in_h2 .text,.in_h2 .in_zh").height($(".in_h2 .text img").height())
var m=$(".in_h2 .text img").height()-20+"px"
$(".in_h2 .text .in_zh").css({"line-height":m})

$(".boxmain-top .text .sub_zh").height($(".in_h2 .text img").height())
var m=$(".boxmain-top .text img").height()-10+"px"
$(".boxmain-top .text .sub_zh").css({"line-height":m})
