...
$("#banner .slideBox").slide({mainCell:".bd ul",autoPlay:true, effect:"fold", trigger:"click" });
...
window.onload=function(){
	...
	$(".about").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-92)
	 }
 )		
...
/*首页产品列表图片自适应*/
adaption(".products .inner ul li .pic",255,255)
