...
$("#pro").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:3,interTime:50});	
$("#case").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:5,interTime:50});	
$("#links").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:6,interTime:50});	
});
...
window.onload=function(){
	...
	$("#about .inner").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-20)
	 }
 )	
...
adaption("#pro .inner ul li .pic",178,175)
adaption("#case .inner ul li .pic",220,220)
