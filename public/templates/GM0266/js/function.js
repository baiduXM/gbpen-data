...
/*美工专属区域*/
var t=($("header").height()-$(".header_menu").height())*0.5
$(".header_menu").css({"top":t})

$("#in_image .tit").height($("#in_image .tit img").height())
$("#in_image .tit span").css({"line-height":$("#in_image .tit img").height()+"px","height":$("#in_image .tit img").height()+"px"})


$(".tit1").height($(".tit1 img").height())
$(".tit1 span").css({"line-height":$(".tit1 img").height()+"px","height":$(".tit1 img").height()+"px"})


$(".boxmain-top .tit,.boxmain-top").height($(".boxmain-top .tit img").height())
$(".boxmain-top .tit span").css({"line-height":$(".boxmain-top .tit img").height()+"px","height":$(".boxmain-top .tit img").height()+"px"})



$(".cc").css({"margin-bottom":-$(".cc").height()+"px"})
$("#in_text .tit span").css({"line-height":$("#in_text .tit img").height()+"px","height":$("#in_text .tit img").height()+"px"})
