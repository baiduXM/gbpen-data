...
<?php /*%%SmartyHeaderCode:4784564c16ab5e0757-64305047%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4784564c16ab5e0757-64305047',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_564c16ab93e240_07405814',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_564c16ab93e240_07405814')) {function content_564c16ab93e240_07405814($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
"  height="126" width="165"/><p class="photo_title2"><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</p></a></li>
        <?php } ?>


               <!--  <li><a href="#1"><img src="images/proimg_01.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
                <li><a href="#1"><img src="images/proimg_02.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
                <li><a href="#1"><img src="images/proimg_03.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
                <li><a href="#1"><img src="images/proimg_01.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
                <li><a href="#1"><img src="images/proimg_02.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
                <li><a href="#1"><img src="images/proimg_03.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
                <li><a href="#1"><img src="images/proimg_02.jpg"  height="126" width="165"/><p class="photo_title">产品名称</p></a></li>
