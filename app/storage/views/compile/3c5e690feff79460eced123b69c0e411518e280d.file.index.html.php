<?php /* Smarty version Smarty-3.1.19, created on 2015-11-09 08:34:56
         compiled from "D:\Unify\app\views\templates\GM0003\index.html" */ ?>
<?php /*%%SmartyHeaderCode:2240456405ab08ac866-98399030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c5e690feff79460eced123b69c0e411518e280d' => 
    array (
      0 => 'D:\\Unify\\app\\views\\templates\\GM0003\\index.html',
      1 => 1446631379,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2240456405ab08ac866-98399030',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56405ab1425a61_23044682',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56405ab1425a61_23044682')) {function content_56405ab1425a61_23044682($_smarty_tpl) {?>﻿<!DOCTYPE html>
...
?>
            ...
            <div class="prod-show">
              <div class="cplib">
                <?php if ($_smarty_tpl->tpl_vars['mIndexCat']->value['childmenu']) {?>
                <div class="prlist_a">
                  <div class="pitlte"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['name'];?>
</div>
                  <ul class="listpp">
                  <?php  $_smarty_tpl->tpl_vars['nav'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['nav']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['mIndexCat']->value['childmenu']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
">
                ...
                <div class="pro-show">
                  <div class="xgcpo_t">
                    <div class="titlead bright">
                      <a href="<?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['link'];?>
">更多</a>
                    </div>
                    <div class="titlead bright"><?php echo $_smarty_tpl->tpl_vars['mIndexCat']->value['name'];?>
</div>
                  </div>
                  <div class="cpszs_show">
                    <ul>
...
" width="100%"></div>
                            <div class="imgword"><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</div>
                          </dl>
                        </a>
                      </li>
...
'">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['article']->value['image'];?>
" width="100%" height="112px"></a>
                  </li>
                  <?php }?>
                  <li class="ptxt word">
                    <a  onclick="javascript:window.location.href='<?php echo $_smarty_tpl->tpl_vars['article']->value['link'];?>
'">
                      <div class="decurlits <?php if (($_smarty_tpl->tpl_vars['article']->index)%2) {?>others<?php }?>">
                        <div class="about-txt">
                          <div class="titlea"><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</div>
                          <div class="pp">
