$(document).ready(function(){
  ...
  doc.addEventListener('DOMContentLoaded',recalc,false);
    ...
    // 标题出现
    $(".ab-title span").animate({left:"0",opacity:"1"},500);
    $(".ab-title .more").animate({right:"0",opacity:"1"},500);
    

    $(window).scroll(function(){
      if($(document).scrollTop()>220 && !$(".pro-title").hasClass("on")){

        $(".pro-title").addClass("on").fadeIn();
      }
    });
