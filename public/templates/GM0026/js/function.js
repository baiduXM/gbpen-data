$(document).ready(function(){
	...
	var img=new Image();
	img.src=$(".slideBox img").attr("src");	
	
	$(".class-m").height($(".class").outerHeight()-$(".class-top").outerHeight())
	$(".index-wrap").height($(".wrap").height())
	if($(window).width()<480)
	{
		var listHeight=$(".baner_zz").height()-$(".baner_zz .title").height()-12
		}else{
		var listHeight=$(".baner_zz").height()-$(".baner_zz .title").height()-40
		}
	$(".baner_zz .zz_list li a").height(listHeight/3)
	$(".baner_zz .zz_list li a").css({"line-height":listHeight/3+"px"})
	});
