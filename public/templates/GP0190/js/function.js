...
<!--设计团队-->
$(".team .inner ").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:3,interTime:50});
...
<!--新闻中心-->
 $(".news").each(
 function(){
	 $(this).find(".newstext").width($(this).width()-$(this).find(".newsimg img").width()-40)
	 }
 )	 
...
adaption(".case .inner ul li .pic",203,203)

adaption(".team .inner ul li .pic",197,197)
