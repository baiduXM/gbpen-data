...
$(".menulist").height($(".menulist .swiper-nav span .pic ").height()+15+"px")
...
$("section div.wrapper:odd .in_zh").css({"color":"#fff","border-color":"#fff"})
$("section div.wrapper:odd .inner").css({"color":"#fff"})
$("section div.wrapper:odd .in_title").css({"color":"#fff"})
$("section div.wrapper:odd .more a").css({"color":"#fff"})
