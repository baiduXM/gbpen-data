...
$("section div.wrapper:odd .in_h2").css({"border-right":"8px solid #fce466","border-left":"none","padding-right":"15px"})
$("section div.wrapper:odd .in_h2 .in_zh").css({"text-align":"right"})
$("section div.wrapper:odd .in_h2 .in_en").css({"text-align":"right"})


$(".list_imagetext ul li").each(function(){
if($(".list_imagetext ul li .img_box").height()<$(".list_imagetext ul li .text_box").height()){
	var z=($(".list_imagetext ul li .text_box").height()-$(".list_imagetext ul li .img_box").height())*0.5
