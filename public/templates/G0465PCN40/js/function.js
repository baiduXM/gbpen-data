...
$(".picScroll-left").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"leftMarquee",autoPlay:true,vis:6,interTime:50,trigger:"click"});
...
<!--关于我们-->
 $(".about").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-30)
	 }
 )	
...
adaption(".products .inner ul li .pic",146,146)
