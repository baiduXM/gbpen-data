...
adap_box("#news",500,290,1030)
adap_box(".about",200,150,330)
...
$("#banner .slideBox").slide({mainCell:".bd ul",autoPlay:true, effect:"fold", trigger:"click",interTime:4000});
    jQuery("#brand .inner").slide({mainCell:".bd ul",autoPlay:true});

    jQuery(".news_img").slide({mainCell:".bd ul",autoPlay:true});
    // jQuery(".pro .inner").slide({mainCell:".bd .ulWrap",autoPlay:true,effect:"leftMarquee",vis:5,interTime: 30});

    // jQuery(".pro .inner").slide({mainCell:".bd .ulWrap",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});
    $(".pro .inner li").each(function(i){
        $(".pro .inner li").slice(i*2,i*2+2).wrapAll("<ul></ul>")
    })
    jQuery(".pro .inner").slide({mainCell:".bd .ulWrap",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});
/*产品详细页图片自适应*/
...
var news_bg = document.getElementsByClassName("news_bg")[0].offsetWidth;
var news_left = news_bg/2;
$(".news_bg").css({
    "marginLeft":-news_left+"px"
});
var product_bg = document.getElementsByClassName("product_bg")[0].offsetWidth;

var product_left = product_bg/2;
$(".product_bg").css({
    "marginLeft":-product_left+"px"
})

var box = document.getElementsByClassName("box_title");
var left = document.getElementsByClassName("left");
var right = document.getElementsByClassName("right");
var content = document.getElementsByClassName("content");
console.log(box[0].offsetWidth);
console.log(left[0].offsetWidth);
console.log(right[0].offsetWidth=box[0].offsetWidth-(left[0].offsetWidth+content[0].offsetWidth));
console.log(content[0].offsetWidth);
console.log($(".box_title:after")[0].offsetWidth)