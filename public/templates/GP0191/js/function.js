...
$("#pro .inner li").each(function(i){
	...
	jQuery("#pro .inner").slide({titCell:".hd ul",mainCell:".bd .ulWrap",autoPlay:true,effect:"leftMarquee",vis:5,interTime:50 ,trigger:"click"});
...
adaption("#pro .inner ul li .pic",170,170)
