...
$(".in_h2").height($(".in_h2 .tit").innerHeight())
$("#in_text ul li .num").height($("#in_text ul li .num img").height())
var t=$("#in_text ul li .num").height()+"px"
$("#in_text ul li .num").css({"line-height":t})

$(".list_text ul li .num").height($(".list_text ul li .num img").height())
var t=$(".list_text ul li .num").height()+"px"
$(".list_text ul li .num").css({"line-height":t})


 $("#in_text ul li .num .shuzi,.list_text ul li .num .shuzi").each(function (i) {
			if(i<9){
        $(this).text("0"+(i+1))}
		else{
			$(this).text(i+1)
...
$("#in_text ul li .pix").width($("#in_text ul li .pix").height())



var h=($("#in_text ul li").height()-$("#in_text ul li .txt").height())*0.5

$("#in_text ul li .txt").css({"margin-top":h})
/*美工专属区域*/
