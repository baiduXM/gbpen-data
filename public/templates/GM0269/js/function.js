...
/*美工专属区域*/
$("section div.wrapper").css({"margin-top":15,"margin-bottom":15})

$("#in_page .tit").height($("#in_page .tit .pix").height())

var s=($("#in_page .tit .pix").width()-$("#in_page .tit .wenzi").width())*0.5
$("#in_page .tit .wenzi").css({"left":s})

var c=($("#in_page .tit .pix").height()-$("#in_page .tit .wenzi").height())*0.15
$("#in_page .tit .wenzi").css({"bottom":c})



$(".boxmain-top .tit").height($(".boxmain-top .tit .pix").height())

var t=($(".boxmain-top .tit").height()-$(".more3").height())*0.7
$(".more3").css({"margin-top":t})

var p=($(".boxmain-top .tit .pix").width()-$(".boxmain-top .tit .wenzi").width())*0.5
$(".boxmain-top .tit .wenzi").css({"left":p})




var y=($(".boxmain-top .tit .pix").height()-$(".boxmain-top .tit .wenzi").height())*0.27
$(".boxmain-top .tit .wenzi").css({"bottom":y})



$(".list_imagetext ul li").each(function(){
if($(this).find(".pix img").height()<$(this).find(".text_box").height()){
	var z=($(this).find(".text_box").height()-$(this).find(".pix img").height())*0.5
	$(this).find(" .pix img").css({"margin-top":z})
	}
	else{	
	$(this).find(" .pix img").css({"margin-top":0})
}
	})
