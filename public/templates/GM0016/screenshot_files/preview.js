// update 2015.4.28 16:47

// 以下为模拟PHP输出数据，变量说明参见：http://pme/wiki/doku.php?id=ued:temple
var PREVIEW_DEMODATA = {
	list: [{
		title: '这是一篇测试文章',
		image: 'http://imgs.meimeinice.com/imgs/5238f7c9fd1087f8f38581fbe74c7878.jpg!small',
...
var PREVIEW_CONFIG = {
	...
	navs: [{
		...
		image: 'http://p.qq181.com/cms/1210/2012100413195471481.jpg',
	...
	for (var k in data) {
		...
		switch (data[k].type) {
			...
			case 'images':
				...
				break;
			case 'list':
				if (typeof data[k].config !== 'undefined' && (typeof data[k].config.limit === 'undefined' || typeof data[k].config.star_only === 'undefined'))
