...
// 头部导航
    $('.topnav').swiper({slidesPerView: 3,freeMode: true,nextButton: '.nav-next',prevButton: '.nav-prev'});

// 文字列表
    $('.newslist').swiper({pagination: '.dotted p',slidesPerView: 1,paginationClickable: true,freeMode: true,autoplay:2500,autoplayDisableOnInteraction:false});
