...
window.onload=function(){
	<!--美工-->
	 ...
	 $("#about .inner").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-120)
	 }
 )
	 ...
	 $("#news .inner").each(
 function(){
	 $(this).find(".news_text").width($(this).width()-$(this).find(".news_img img").width()-35)
	 }
 )
...
/*首页产品列表图片自适应*/
 adaption("#pro ul li .pro_img",255,255)
