...
/*美工专属区域*/
var w=$(".swiper-nav img").height()+50
    $(".swiper-nav").height(w);
	
	$(".index .wrapper:first").find(".in_h2").css({"margin-top":0,"padding-top":20+"px"})
	$(".index .wrapper:first").find(".inner").css("padding-bottom",20+"px")
   
$(".in_image ul li .in_proimg").height($(".in_image ul li .in_proimg").width())


$(".menulist,.menulist .navlist,.menulist .swiper-nav,swiper-slide").height($(".menulist .swiper-nav a").height())
/*美工专属区域*/
