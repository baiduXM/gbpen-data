...
$("#in_image .pix2").height($("#in_image .pix2 img").height())
$(".xx").height($(".xx img").height())
$(".xx").width($(".xx img").width())

var m=$(".boxmain-top .tit img").height()+"px"

$(".boxmain-top,.boxmain-top .tit").height(m)
$(".boxmain-top .tit .in_zh").css({"height":m,"line-height":m})
