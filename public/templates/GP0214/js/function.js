...
<!--美工-->
  ...
  $(".case ul li").hover(
	...
	function(){
		 ...
		 $(this).find(".bg").css("backgroundImage","url(images/case_bg.png)")
		 $(this).find(".more").animate({top:85,opacity:"1"})
		 },
	
	function(){
		 $(this).find("p").animate({opacity:"0"})
		 $(this).find(".bg").css("backgroundImage","none")
		$(this).find(".more").animate({top:-115,opacity:"0"})		  
  }
  )
...
adaption(".case .inner ul li .pic",230,230)
