...
$("div section .xx").css({"margin-top":30,"margin-bottom":30, })


	$("#in_image .bot ").find("li:nth-child(3n)").css({"background":"#0669ac"})
	$("#in_image .bot").each(function(n){
     if(n%2==0){$(this).addClass("bj1")}
     if(n%2==1){$(this).addClass("bj2")}
     if(n%2==2){$(this).addClass("bj3")}
       })
