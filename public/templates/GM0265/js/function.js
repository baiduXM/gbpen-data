...
$("section div.wrapper").css({"margin-bottom":"20px","margin-top":"10px"})
$(".menulist .swiper-nav span .icon i.iconfont").css({"color":"#fff"})

$("#in_text ul li .bg").height($("#in_text ul li .bg").width())
$("#in_text ul li .in_data").height($("#in_text ul li .in_data").width())

$(".in_h2 .pix").css({"margin-top":-$(".in_h2 .pix img").height()*0.4+"px"})


$(".list_text ul li .bg").height($(".list_text ul li .bg").width())
$(".list_text ul li .in_data").height($(".list_text ul li .in_data").width())



$(".menulist .navlist,.swiper-slide,.menulist .swiper-nav .swiper-wrapper").height($(".menulist .swiper-nav span").innerHeight())
$("#in_text ul li").eq(2).css({"border":"none"})
