...
$(".products .inner li").each(function(i){
		$(".products .inner li").slice(i*2,i*2+2).wrapAll("<ul></ul>")
	})
	jQuery(".products .inner").slide({titCell:".hd ul",mainCell:".bd .ulWrap",autoPlay:true,effect:"leftMarquee",vis:5,interTime:50 ,trigger:"click"});
...
/*首页产品列表图片自适应*/
adaption(".products .inner li .pic",180,180)
