...
/*美工专属区域*/
$(".swiper-slide,.menulist .swiper-nav .swiper-wrapper,.swiper-nav").height($(".swiper-nav span").height()+15)
var n=($(".swiper-nav span a .pic").height()-$(".swiper-nav span a .pic .iconfont").height())*0.5
$(".swiper-nav span a .pic .iconfont").css({"font-size":22,"margin-top":n})

$("#in_image .inner ul li").eq(0).css({"margin-top":"-30px"})
$("#in_image .inner ul li").eq(3).css({"margin-top":"-20px"})
var b=($("#in_image .inner").width()-$("#in_image .inner .line").width())*0.5
$("#in_image .inner .line").css({"left":b})
var c=($("#in_image .inner").width()-$(".aa").width())*0.5
$(".aa").css({"left":c})
