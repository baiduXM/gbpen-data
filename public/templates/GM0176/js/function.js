...
$("section div.wrapper:last").css({"margin-bottom":"10px"})

var h=($(".in_h2").width()-$(".in_h2 .text").width())*0.5
$(".in_h2 .text").css({"left":h})
$(".in_h2").height($(".in_h2 .text").height())


$("#in_text ul li .date").height($("#in_text ul li .in_des").height())
$("#in_text ul li .date").css({"line-height":$("#in_text ul li .date").height()+"px"})


$(".swiper-slide,.menulist .swiper-nav .swiper-wrapper").height($(".menulist .swiper-nav span").innerHeight())
$(".menulist .swiper-nav span:first").css({"background":"#f39802"})
$(".menulist .swiper-nav span .icon i.iconfont").css({"font-size":25,"color":"#fff"})
