...
<!--新闻中心-->
 $(".news .inner").each(
 function(){
	 $(this).find(".news_text").width($(this).width()-$(this).find(".tu_img img").width()-45)
	 }
 )
...
<!--产品-->
$(".products .inner").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:7,interTime:50});
...
/*首页产品列表图片自适应*/
adaption(".products .inner ul li .pic",130,130)
