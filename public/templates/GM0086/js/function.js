...
$(".header").css({"margin-left":-$(".header").width()*0.5})
$(".home,.header_menu").css({"top":$(".header").height()*0.4})



$(".menulist .swiper-nav span").height($(".menulist .swiper-nav span").width())
$(".swiper-slide,.swiper-wrapper,.navlist,.menulist").height($(".menulist .swiper-nav span").height())
...
$(".menulist .swiper-nav span .pic").height($(".menulist .swiper-nav span .pic img").height())
$(".menulist .swiper-nav span .pic").css({"margin-left":$(".menulist .swiper-nav span .bg").width()*0.38})

$("#in_text ul li:first-child").css({"margin-bottom":15})
$(".in_h2").height($(".in_h2").width())
$("#in_image .inner").height($("#in_image .inner ul li").height())

 $("section div.wrapper .in_more1").each(function (i) {
        $(this).text(i+1);
      });
