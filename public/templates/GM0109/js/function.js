$(document).ready(function(){
	...
	$("#iconp i").css({"font-size":$(".menu .menulist dd").width()/4})
  ...
  function pageSlideOver1(){
    $('.page-outd').live('transitionend', function(){
      $(this).removeClass('page-outd');
    });
    $('.page-ind').live('transitionend', function(){
      $(this).removeClass('page-ind');
    });
  }
  ...
  $("#fenlei").click(function(){
		$(".fenlei").removeClass("page-prevd").addClass("page-ind");
		$(".opacity2").show()
		pageSlideOver1();
		
	})
	
	$('.fenlei-close').click(function(){
		$(".fenlei").addClass("page-prevd page-outd")
...
$(".back-top").click(function(){$(".index-wrap").animate({scrollTop :0}, 800)})
	...
	$(".share-cance").click(function(){
	 ...
	 // $(".news_list li").hide();	
    size_lix = $(".news_list li").size();
    xx=4;
    // $('.news_list li:lt('+xx+')').show();
    $('#more').click(function () {
        xx= (xx+4 <= size_lix) ? xx+4 : size_lix;
        $('.news_list li:lt('+xx+')').fadeIn();
        if(xx == size_lix){
            // $('#more').hide();
			// $('#less_more').show();
        }
	 ...
	 // $("ul.picture2 li").hide();	
    size_li = $("ul.picture2 li").size();
    x=6;
    // $('ul.picture2 li:lt('+x+')').show();
    $('#more').click(function () {
