...
window.onload=function(){
	...
	$("#product .inner").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:6,interTime:50});
...
/*首页产品列表图片自适应*/
 adaption("#product .inner ul li .pic",125,125)
adaption("#case .inner ul li .pic",95,95)
...
/*产品详细页*/
 ...
 // 兼容低版本IE
	...
	$(window).load(function(){
		$("#news ul li").eq(0).css({"margin-top":"0px","padding-top":"5"}) 	
		$(".main").fadeIn(900)
		$(".sidebar").delay(600).fadeIn()
	    $(".first").prepend( '<span class="bg"></span>' );
		$(".first").eq(0).css({"margin-top":"0px"}) 	
		$(".first").hover(   
		function(){
      $(this).children("span").stop().animate({width:"200"})
	  
	  
	  },
	  function(){
		 $(this).children("span").stop().animate({width:"1px"})  
		  }
			)
		})
