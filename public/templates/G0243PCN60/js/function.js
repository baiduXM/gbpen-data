...
$(".news").each(
 function(){
$(this).find(".news_text").width($(this).width()-$(this).find(".news_img img").width()-80)
	 }
 )	
...
<!--关于我们-->
 $(".about").each(
 function(){
	 $(this).find(".about_text").width($(this).width()-$(this).find(".about_img img").width()-80)
	 }
 )	
...
adaption(".case .inner ul li .pic",200,200)


$(".team .inner .slideBox").slide({mainCell:".bd ul",autoPlay:true,effect:"leftLoop",nterTime:3000});
