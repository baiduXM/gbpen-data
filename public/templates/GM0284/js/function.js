...
/*美工专属区域*/
var u=($("header").height()-$(".header_menu").height())*0.5
$(".header_menu").css({"top":u})



$(".list_imagetext ul li:first-child").css({"margin-top":10})


var t=$(".in_h2 img").height()+"px"
$(".in_h2").height(t)
$(".in_h2 span,.in_h2 .more").css({"line-height":t,"height":t})




var r=$(".boxmain-top img").height()+"px"
$(".boxmain-top").height(r)
$(".boxmain-top b,.more3").css({"line-height":r,"height":r})
