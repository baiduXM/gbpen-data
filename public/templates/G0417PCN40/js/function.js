...
<!--美工-->
$("#pro").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});	

$("#pro .inner ul li:odd").addClass("pro1");
$("#pro .inner ul li:even").addClass("pro2");
...
adaption("#pro .inner ul li .pic",288,288)
