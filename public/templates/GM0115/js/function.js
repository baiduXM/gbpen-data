...
$(".in_more").width($(".in_h2 .in_zh").width())

var m=($(".in_h2").width()-$(".in_h2 .in_zh").width())*0.5
$(".in_h2 .in_zh").css({"margin-left":m})
$(".in_more").css({"margin-left":m})
$("#in_image ul li").height($(".insub_image ul li .in_proimg").height())

var h=($("#in_image ul li").height()-$("#in_image ul li .in_protitle").height())*0.28
$("#in_image ul li .in_protitle").css({"top":h})

var c=($("#in_image ul li").width()-$("#in_image ul li .in_protitle").width())*0.5
$("#in_image ul li .in_protitle").css({"left":c})


var u=($("#in_image ul li").height()-$("#in_image ul li .txt").height())*0.5
$("#in_image ul li .txt").css({"top":u})
...
$("#in_text .inner").height($("#in_text .inner .newsimg").height()+12)
$("ul.newslist").height(($("ul.newslist li").height())*3)




var e=($("#in_text .inner").height()-$("ul.newslist").height())*0.5
$("ul.newslist").css({"margin-top":e})

$(".list_imagetext ul li").each(function(){
if($(".list_imagetext ul li .img_box").height()<$(".list_imagetext ul li .text_box").height()){
	var z=($(".list_imagetext ul li .text_box").height()-$(".list_imagetext ul li .img_box img").height())*0.5
	$(".list_imagetext ul li .img_box ").css({"margin-top":z})
	}})
