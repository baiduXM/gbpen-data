...
<!--美工-->
 ...
 $(".about_text").width(305-$(".about_img img").width())
...
window.onload=function(){
	<!--美工-->
	if($(".about_img img").width()<=200){
	 $(".about_text").width(295-$(".about_img img").width())}
	 else{
		 $(".about_img img").width(200)
		$(".about_text").width(95)
		 }
     if($(".news_text img").width()<=180){
	 $(".news_text").width(330-$(".news_img img").width())}
	 else{
		 $(".about_img img").width(180)
		$(".about_text").width(145)
		 }
	 <!--美工-->
...
adaption(".pro .inner ul li .pic",160,160)
