...
$("#in_page .tit").height($("#in_page .tit .text").height())
$("#in_image .tit").height($("#in_image .tit .text").height())
$("#in_text .tit").height($("#in_text .tit .text").height())

$(".boxmain-top .tit").height($(".boxmain-top .tit .text").height())
