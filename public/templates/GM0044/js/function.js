$(document).ready(function(){
	...
	$('.rightbox:last').addClass("rigline");
...
window.onload=function(){
   ...
   h=h*0.8;
	...
	$('.topimg').height(hii*3/4+"px") 
	  $(".menulist .swiper-nav span .circle").height($(".menulist .swiper-nav span .circle").width())
	   $(".menulist .swiper-nav span .circle1").height($(".menulist .swiper-nav span .circle1").width())
	   $("ul.news-list2 li").height($("ul.news-list2 li").width())
